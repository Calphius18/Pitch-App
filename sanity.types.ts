...
// Query: *[_type == "startup" && _id == $id][0] {    _id,    title,    views  }
...
// Query: *[_type == "startup" && author._ref == $id]{  _id,  _type,  _createdAt,  _updatedAt,  _rev,  title,  slug,  description,  category,  views,  image,  author->{ _id, name, image, bio }}
